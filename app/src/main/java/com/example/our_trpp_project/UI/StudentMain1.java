...
public class StudentMain1 extends Fragment implements SubjectAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ava_image = rootView.findViewById(R.id.imageView5);
        ...
        ava_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Переход к фрагменту StudentCabinet
                Navigation.findNavController(v).navigate(R.id.action_studentMain1_to_studentCabinet);
            }
        });
